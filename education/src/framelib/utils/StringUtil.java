...
//    	list.add("AB");
    ...
    /**
     * Title：
     * Description：把空字符串替换为""
     * @Create_by:yangzongshan
	...
	/**
	 * 方法描述：去掉字符串最后一个分割字符 2013-9-23, 上午09:13:30
	 * 
	 * @Create_by:hanlongfei
	 * @param str
	 *            源串
	 * @param split
	 *            分割字符
	 ...
	 * @throws Exception
	 */
	public static String cutLastChar(String str, String split) throws Exception {
		try {
			if (!isEmpty(str)) {
			...
			throw new SystemException("stringNotCorrect");
		}
	}
     ...
     * @return
     */
    public static List<Long> getLongListBySplit(String str, String split, String except){
	 ...
	 * @Last_Edit_By:
	 * @Edit_Description
	 * @Create_Version:BMP 1.0
	 */
	public static String joinToString(String[] args,String cuter){
