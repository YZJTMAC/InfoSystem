...
<script id="addEduPartB" type="text/x-jquery-tmpl">
		...
		<ul class="forminfo forminfo1" style="padding: 0; margin: 0;">
									...
									<li>
										...
										<div class="vocation" style="padding-right: 8px;">
											<textarea name="mobilizeMark" id="mobilizeMark" disabled="disabled" cols=""
    ...
    <div class="itab">
  	<ul> 
    <li><a href="<%=basePathHeader %>/teacher/teachermanage/toDeadAddPage.htm?click=14">发起死亡登记</a></li>
    <li><a href="###" class="selected">已发起死亡登记</a></li> 
    <li>
		<!-- <a href="###">教师死亡登记导入</a> -->
	</li>
  	</ul>
