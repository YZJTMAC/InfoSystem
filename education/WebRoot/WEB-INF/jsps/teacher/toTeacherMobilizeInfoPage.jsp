			...
			<div class="formbody">
				...
				<div class="chauxnJS jsTool">
					<span style="float: left;"><h4 style="float: left;">
						...
						href="<%=basePathHeader%>/teacher/teachermanage/teacherMobilizeList.htm?click=1900"
						class="huibtn_a"
				...
				<dl class="teacherdlxinxi">
					<dt>
						<img src="<%=imageServer%>/${info.userImageUrl}"
							title="头像" />
					</dt>
					<dd>
