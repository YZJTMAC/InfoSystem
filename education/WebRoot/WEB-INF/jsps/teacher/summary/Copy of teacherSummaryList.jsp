	...
	<div class="content">
		...
		<div class="formbody" style="width: 97%">
			<div class="tabson">
				<ul class="seachform">
					<li><label>项目名称：</label> <input name="input" id="projectName"
						name="projectName" type="text" class="scinput" /></li>
					<li><label>项目年度：</label>
						<div class="vocation">
					...
					<li>
						<div class="vocation">
							<select class="select3 yearpicker" name="endTime" id="endTime"></select>
						</div></li>
			...
			<div class="tip" style="height:500px;z-index: 1">
				<div class="tiptop">
					<span><d class="ctype"></d>我的培训总结</span><span>&nbsp;&nbsp;</span><a></a>
				</div>
				<div class="tipinfo"
					style="width:470px; height:360px;padding:10px; margin:0;">
					<ul class="forminfo" style="padding:0; margin:0;">
						<li><label>标题：</label><cite><input id="summaryTitle"
								name="summaryTitle" type="text" class="scinput" value="" />
						</cite>
						</li>
						<li><label><d class="ctype"></d>总结：</label>
							<div class="vocation" style="padding-right:8px;">
								<textarea id="summaryContent" name="summaryContent" cols=""
									rows="" class="textinput"
									style="width:260px; height:270px;overflow-y:auto"></textarea>
							</div>
						</li>
						<li><label>附件：</label><cite id="cite"><a id="download"
								href="#"></a><a id="delete" href="#"></a>
						</cite>
						</li>
					</ul>
				</div>
				<div class="tipbtn">
					<span class="sl-custom-file"> 
						...
						<input	id="attchmentPath" type="file" onchange="check()"
						name="attchmentPath" class="ui-input-file" />&nbsp;&nbsp; </span> <input
						name="" type="button" class="sure" value="保存" />
				</div>
			</div>
		</div>
	</div>
