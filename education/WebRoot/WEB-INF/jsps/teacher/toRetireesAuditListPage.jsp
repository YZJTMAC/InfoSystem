				...
				<div id="usual1" class="usual">
					...
					<div class="itab">
						<ul id="action">
							...
							<li>
								<a id="N"
									href="<%=basePathHeader%>/teacher/teachermanage/toRetireesAuditListPage.htm?click=1004&flag=N">待审核离退休</a>
							</li>
							<li>
								<a id="Y"
									href="<%=basePathHeader%>/teacher/teachermanage/toRetireesAuditListPage.htm?click=1004&flag=Y">已审核离退休</a>
							</li>
						</ul>
					</div>
						...
						<div class="tabson">
							...
							<ul class="seachform">
								...
								<li>
									...
									<input readonly="readonly" name="input" id="tss" value="选 择"
								...
								<li>
									...
									<input id="changeType" type="hidden" value="9" />
									<input id="retireesType" type="hidden" value="" />
