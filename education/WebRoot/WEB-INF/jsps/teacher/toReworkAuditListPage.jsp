				...
				<div id="usual1" class="usual">
					...
					<div class="itab">
						<ul id="action">
							...
							<li>
								<a id="N"
									href="<%=basePathHeader%>/teacher/teachermanage/toReworkAuditListPage.htm?click=1006&flag=N">待审核返聘</a>
							</li>
							<li>
								<a id="Y"
									href="<%=basePathHeader%>/teacher/teachermanage/toReworkAuditListPage.htm?click=1006&flag=Y">已审核返聘</a>
							</li>
						</ul>
					</div>
						...
						<div class="tabson">
							...
							<ul class="seachform">
								...
								<li>
									...
									<input id="changeType" type="hidden" value="40" />
