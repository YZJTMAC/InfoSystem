			...
			<div class="formbody">
				<div id="usual1" class="usual">
					...
					<div class="itab">
						<ul>
							<li>
								<a href="###"  class="selected">发起离岗</a>
							</li>
							<li>
								<a id="goto" href="<%=basePathHeader %>/teacher/teachermanage/teacherDimissionPage.htm?click=13">已发起离岗</a>
							</li>
							 <li>
								<!-- <a href="###">教师离岗导入</a> -->
							</li>
				...
				<div class="tip2">
				    	<div class="tiptop2"><span>离岗说明</span><span>&nbsp;&nbsp;带“<b
									style="color: #F00;"">*</b>”为必填项</span><a></a></div>
