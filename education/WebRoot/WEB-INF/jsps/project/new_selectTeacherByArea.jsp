...
<script type="text/javascript" src="<%=basePathHeader%>/javascript/project/new_teacherListForReport.js"></script>
...
<div id="alertDiv" class="tip"  style="height: 200px; margin-top: 200px;">
		...
		<div class="tipinfo">
      	<div class="tipright" style="padding:0; margin:0;"></div>
        	<ul class="forminfo" style="padding:0; margin:0;">
				<li >
			  		<h4 style="margin-left: 70px;" id="alertInfo">报名失败，请确认是否符合报名条件！</h4>
			  	</li>
		    </ul>
		</div>
