...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePathHeader%>/javascript/project/teacherListForAuditesChaxunbaomingShenHeBuTongGuo.js"></script>
	</head>
	<body>
		<!-- top -->
	<div class="head">
...
<div class="chauxnJS jsTool">
          <span style="float:left;">
           <a onclick="change(1);" id="tab_1" href="#tab1" class="selected">未审核</a>
          <a onclick="change(2);" id="tab_2" href="#tab2">审核通过</a>
         <a onclick="change(3);"  id="tab_3" href="#tab2">审核未通过</a>
  </div>
