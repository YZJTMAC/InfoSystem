...
<script type="text/javascript" src="<%=basePathHeader%>/javascript/project/projectList.js"></script>
...
<body>
    ...
    <div class="itab">
  	<ul>
	    <li><a href="#tab1" class="selected">进行中<span class="ctype"></span></a></li>
	    <li><a href="#tab2">待申报准备中<span class="ctype"></span></a></li>
		<li><a href="#tab2">审批通过筹备中<span class="ctype"></span></a></li>
		<li><a href="#tab2">已结束<span class="ctype"></span></a></li>
		<li><a href="#tab2">已关闭<span class="ctype"></span></a></li>
  	</ul>
...
<ul class="seachform">
  <li>
         ...
         <li>
          ...
          <li>
          	<a href="<%=basePathHeader%>/edupm/projectmanage/toAddProPage.htm?click=0" class="dian3">创建新项目</a>
          </li>
        </ul>
      </div>
