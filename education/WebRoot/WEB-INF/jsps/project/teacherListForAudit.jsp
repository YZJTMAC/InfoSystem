...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePathHeader%>/javascript/project/teacherListForAudit.js"></script>
	...
	<body>
		...
		<div style="width:70%; float:left;">	
			<div class="chauxnJS jsTool">
			          ...
			          <a href="javascript:cancelAuditAll();" class="huibtn_a  " style=" margin-left:6px">全部取消审核</a>&nbsp; 	
			          <a href="javascript:cancelRegistrationAll();" class="huibtn_a  " style=" margin-left:6px">全部取消报名</a>&nbsp; 	</span>
