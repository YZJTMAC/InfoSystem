...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<%=basePathHeader%>/javascript/project/addModelInfo.js"></script>
		<script type="text/javascript">
			var projectId = '<%=request.getParameter("projectId")%>';
			var ScopeId = '<%=request.getParameter("id")%>';
		</script>
		<script type="text/javascript">
			...
			<div class="formbody">
				...
				<ul class="seachform">
					<li style="width: 472px">
						...
						<label style="width: 120px">
							<font style="color: red">*</font>项目性质：
						</label>
						 <div class="vocation">
	            <select  class="select2"  id = "modelCode"  name="modelCode">
	            </select>
	          </div>
	          <a id="modelCodeError" style="color: red"></a>
					</li>
