...
<script type="text/javascript" src="<%=basePathHeader%>/javascript/project/projectPaperAndAssessList.js"></script>
		...
		<div class="tabson" id="starting">
			<ul class="seachform">
	         ...
	         <li>
	          ...
	          <li>
	          	 <select name="select" class="select2 yearpicker" width="110px;" id="beginDate" >
	          	 	<option value="">请选择</option>
	          	</select>  
	          </li>
	          <li>--</li>
	          <li>
	           <select name="select" class="select2 yearpicker" width="110px;" id="endDate">
	          	 	<option value="">请选择</option>
	          </select>
	          </li>
				 <li>
