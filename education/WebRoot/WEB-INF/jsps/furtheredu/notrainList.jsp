...
<script type="text/javascript" src="<%=basePathHeader%>/javascript/furtheredu/notrainList.js"></script>
		...
		<div class="formbody">
			...
			<div class="chauxnJS jsTool">
				<span style="float:left;"> <a
					href="<%=basePathHeader%>/furtheredu/certificate/notrainAddPage.htm?click=6" class="huibtn_a click" style="margin-left:6px">添加</a> </span> 
