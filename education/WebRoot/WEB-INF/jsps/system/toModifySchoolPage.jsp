...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<%=basePathHeader%>/javascript/system/toModifySchoolPage.js"></script>

		<script type="text/javascript">
			$(document).ready(function(e) {
				$('#schoolEstablishId').val(${info.establishTypeId});
				$('#schoolTypeId').val(${info.schoolTypeId});
				$('#schoolNatureId').val(${info.schoolNatureId});
				$('#areaTypeId').val(${info.areaTypeId});
				$(".select2").uedSelect( {
					width : 135
				});
				$(".select4").uedSelect( {
				...
				<div class="tabson" id="txtBox">
					...
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td colspan="2">
								<input name="input" id="tss" onclick="clearPCD();" type="text"
									style="width: 240px;" value="${info.schoolProvinceName}"
						...
						<tr>
							...
							<td width="260">
								<input id="schoolName" maxlength="50" name="input" type="text"
									class="scinput" value="${info.schoolName}" />
							</td>
							<td width="60">
								&nbsp;
							</td>
						...
						<tr>
							...
							<td width="260">
								<input id="schoolContacts" name="input" maxlength="20"
									type="text" class="scinput" value="${info.schoolContacts}" />
							</td>
							<td width="60">
								&nbsp;
							</td>
							...
							<td width="260">
								<input id="schoolContactsType" name="input" maxlength="20"
									type="text" class="scinput" style="width: 135px" value="${info.schoolContactsType}" />
							</td>
						</tr>
						...
						<tr>
							...
							<td width="260">
							<input id="schoolCode" name="input" maxlength="20"
									type="text" class="scinput" style="width: 135px" value="${info.schoolCode}" />
						 	<input id="oldSchoolCode" name="input" maxlength="20"
									type="hidden" class="scinput" style="width: 135px" value="${info.schoolCode}" />
							</td>
						</tr>
						...
						<tr>
							...
							<td colspan="4">
								<input id="schoolContactsAddress" name="input4" maxlength="100"
									...
									value="${info.schoolContactsAddress}" style="width: 514px;" />
							</td>
						</tr>
						...
						<tr>
							...
							<td colspan="4">
								<textarea id="schoolMemo" maxlength="300" name="textarea"
									style="width: 514px; height: 100px; max-width: 514px; border: 1px solid #ccc; border-color: #a7b5bc #ced9df #ced9df #a7b5bc;">${info.schoolMemo}</textarea>
							</td>
						</tr>
						<tr>
							<td></td>
					...
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td>
								<input name="btn" id="btn" onclick="modifySchool();"
