...
%>
<script type="text/javascript" src="<%=basePath%>/javascript/jquery.messager.js"></script>
<script type="text/javascript" src="<%=basePath%>/javascript/system/loginCommon.js"></script>
<script type="text/javascript" src="<%=basePath%>/javascript/message/messageCounts.js"></script>
...
<ul class="nav">
	...
	<toolbar:enable uri="comparison_001">
		<li>
			<a id="comparison" href="<%=basePath%>/person/index5.htm" >
			<img src="<%=basePath%>/images/icon07.png" title="活动评比" style="height: 45px;width: 45px;"/>
				<h2>
					活动评比
				</h2> </a>
		</li>
...
<div class="topright">
	...
	<div class="user">
		...
		<i><a href="<%=basePath%>/message/messageManagement/messageList.htm?click=3" style="color: #FFF;">通知</a> </i>
