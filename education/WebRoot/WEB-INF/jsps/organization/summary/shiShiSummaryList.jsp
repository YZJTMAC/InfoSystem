...
<title>实施机构培训总结</title>
<%@include file="../../common/commonHead.jsp"%>
<script type=text/javascript src="<%=basePathHeader%>/javascript/common/pagination.js"></script>
<script type="text/javascript" src="<%=basePathHeader%>/javascript/organization/shiShiSummaryList.js"></script>
...
<div class="content">
	<div class="place">
		...
		<ul class="placeul">
			...
			<li>
				培训项目总结:培训成绩公布之后,实施管理员可以查看教师提交的培训项目总结,也可上传培训项目总结附件供行政管理员查看和下载使用
			</li>
		</ul>
	</div>
	<div class="formbody">
