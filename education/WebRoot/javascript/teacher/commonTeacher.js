...
function jobInfo(data) {
	...
	if (jobInfo.teacherStaff == null || jobInfo.adjustId.length == 0 || jobInfo.adjustId == "")
		$('#adjustId').html("");
	else {
	...
	if (jobInfo.jobSchoolAdministrationOffice == null
			|| jobInfo.jobSchoolAdministrationOffice.length == 0
			|| jobInfo.jobSchoolAdministrationOffice == "")
		$('#jobSchoolAdministrationOffice').val("");
	else
		$('#jobSchoolAdministrationOffice').val(
				jobInfo.jobSchoolAdministrationOffice);
