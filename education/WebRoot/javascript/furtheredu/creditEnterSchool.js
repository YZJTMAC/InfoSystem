$(document).ready(function(e) {
	//$("#projectName").html("<b>项目名称:"+GetURLParameter("projectName")+"</b>");
 
	//txtTeacherName
	//$("#txtTeacherName").val(GetURLParameter("projectName"));
	...
	$("#chkAll").click(function(){
		if(this.checked){
			$("input[name='chkEnterCredit']").attr("checked",$(this).attr("checked"));
		}
		else{
	...
	$("#txtSchoolId").val(rootId);
	 $.post(pathHeader + '/org/orgRegionList.do?isSchool=true&rootId='+rootId,function(result){
...
function onClick(e,treeId, treeNode) {
	  		setAreaIdByTree(treeNode);
	  		
	  		getUserList();
}

function setAreaIdByTree(treeNode){
