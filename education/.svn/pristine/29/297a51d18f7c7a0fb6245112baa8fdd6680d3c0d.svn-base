...
<title>自主研修查询与申报</title>

<%@include file="../common/commonHead.jsp"%>
<link />
<script type="text/javascript" src="<%=basePathHeader%>/javascript/common/dateFormat.js"></script> 
<script type="text/javascript" src="<%=basePathHeader%>/javascript/common/pagination.js"></script>
<script type="text/javascript" src="<%=basePathHeader%>/javascript/teacher/toDeclareIndependentStudy.js"></script>
</head>
    	...
    	<div class="formbody">
	      	...
	      	<div class="chauxnJS jsTool">
				<span style="float: left;margin-left: 20px">
					<a onclick="depStudyAdd()">申报自主研修</a> 
				</span>
			</div>
			<table class="tablelist" >
				<thead>
	          		<tr>
			            <th width="10%">年份</th>
			            <th width="10%">自主研修类型</th>
			            <th width="40%">自主研修说明</th>
			            <th width="10%">获得学分</th>
			            <th width="10%">审核状态</th>
			            <th width="10%">附件</th>
			            <th width="10%">操作</th>
