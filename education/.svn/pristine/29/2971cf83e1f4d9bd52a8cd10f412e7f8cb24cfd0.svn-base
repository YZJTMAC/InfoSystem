...
<head>
	...
	<script type="text/javascript" src="<%=basePathHeader%>/javascript/message/messageSendByProject.js"></script>
		...
		<div class="formbody">
			<div class="itab">
				<ul>
					...
					<li>
						<a id="tab_3" href="<%=basePathHeader %>/message/messageManagement/sendMessageByProject.htm?click=3" class="selected">选择项目
						</a>
					</li>
					<li>
			...
			<div class="explain">
				说明：通知范围由<span style="color: red;">所选项目以及接收者</span>共同确定
				<br/>
				<span>实例：假设省管理员选择<span style="color: red">某一项目</span>，接收者勾选
				<span style="color: red">参训教师</span>，则<span style="color: red">该项目下的所有参训教师</span>都能看到该通知</span>
			</div>
					...
					<table border="0" cellspacing="0" cellpadding="0" style="width:100%;line-height: 40px; margin: 0 auto;">
						<tbody>
							<tr>
								...
								<td width="260">
									<select id="projectList" name="projectId" class="select3">
										<option selected="selected" value="">请选择</option>
									</select>
								</td>
								<td width="84"><font color="red">*</font>接收者：</td>
								<td width="465">
									<label><input type="checkbox" name="joinTeacher"  value="1"/>参训教师&nbsp;&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="projectApplicant" value="1"/>承培项目申报人</label>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3"><textarea id="content" name="content" style="width: 760px;"></textarea>
								</td>
							</tr>
							 <tr>
								<td>附件：</td>
