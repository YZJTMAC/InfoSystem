			...
			<div class="formbody">
				<div id="usual1" class="usual">
					...
					<div class="itab">
						<ul>
							<li>
								<a href="###"  class="selected">发起病休</a>
							</li>
							<li>
								<a id="goto" href="<%=basePathHeader %>/teacher/teachermanage/teacherSickPage.htm?click=12">已发起病休</a>
							</li>
							<li>
								<!-- <a href="###">教师病休导入</a> -->
							</li>
				...
				<div class="tip2">
				    	<div class="tiptop2"><span>病休说明</span><span>&nbsp;&nbsp;带“<b
