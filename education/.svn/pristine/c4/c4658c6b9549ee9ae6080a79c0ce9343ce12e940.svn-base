...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<%=basePathHeader%>/javascript/system/organizationManagePage.js">
		</script>
		<script type="text/javascript"
				...
				<div class="formbodyL"
					...
					<div class="chauxnJS jsTool">
						...
						<span style="float: left;"> <a href="#" 
							 style="margin-left: 6px" onclick="addInfo(1)">添加</a>
							 <a href="#" class="huibtn_a click"
							 style="margin-left: 6px" id="btnAdd2" onclick="importInfo(1)">批量导入</a>
						</span>
