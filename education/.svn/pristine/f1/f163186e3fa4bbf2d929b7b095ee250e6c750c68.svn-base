...
<title>能力提升数据导入</title>
<%@include file="../common/commonHead.jsp"%>
<script type="text/javascript" 	src="<%=basePathHeader%>/javascript/common/commonUploadFile.js"></script>
<script type="text/javascript" src="<%=basePathHeader%>/javascript/system/fjimport.js"></script>
</head>
<body>
	<!-- top -->
	<div class="head">
						...
						<div class="Uploadiv">
							<ul class="Uploadinfo">
								...
								<li style="text-align: center;">
									...
									<input type="button" class="btn" value="数据模板" style="float:left;margin-left:220px;" onclick="download('fjimport.xls');"/>
									&nbsp;&nbsp;&nbsp;&nbsp;
