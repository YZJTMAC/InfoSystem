...
<script type="text/javascript" src="<%=basePathHeader%>/javascript/project/importTeachers.js"></script>
</head>
<body>
	<!-- top -->
	<div class="head">
...
<div class="content">
			...
			<div class="formbody">
						...
						<div class="Uploadiv">
							<ul class="Uploadinfo">
								...
								<li style="text-align: center;">
									...
									<input type="button" class="btn" value="数据模板" style="float:left;margin-left:220px;" onclick="download();"/>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<span class="sl-custom-file">
								    <input name="" type="button"  class="btn" value="上传附件" />
								    <input id="ff" type="file" name="ff" class="ui-input-file"  style="font-size:37px"; onchange="uploadFile()"/>
								</span>
								</li>
							</ul>
						</div>
					...
					<div class="Uploadiv">
						...
						<ul class="Uploadinfo">
							...
							<li style="text-align: center;">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="" type="button" class="btn" value="检测数据" onclick="importTeachers();" id="checkDataBtn" />
							</li>
					...
					<div class="Uploadiv">
						...
						<ul class="Uploadinfo" style="height: auto;">
							...
							<li style="text-align: center;">
								...
								<a href="javascript:showTip();" class="huibtn_a click"><img	src="<%=path%>/images/shgbg.png" />数据校验规则</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<input name="" type="button" class="btn" value="合并下载" onclick="downZip();" style="display: none" id="downZip"/>
								&nbsp;&nbsp;&nbsp;&nbsp;
									<input name="" type="button" class="btn" value="提交" onclick="submitData()" id="submitD" disabled="disabled"/>
							</li>
				...
				<div class="tip" style="height: 840px;" id="importRole">
					<div class="tiptop">
						<span>数据校验规则</span><a href="javascript:hideTip();"></a>
					</div>

					<div class="tipinfo" style="height: 700px;">
						...
						<li><label style="width: 60px;">区县：</label><label style="width: 320px;">选填，同上；</label></li>-->
							...
							<li>
								...
								<label style="width: 320px;">
									选填，不可重复，4-20位英文、数字或下划线组合，第1位必须为字母；
								</label>
							</li>
							<!-- <li>
								<label style="width: 60px;">
					...
					<div class="tipbtn">
						<input name="" type="button" class="sure" value="确定" onclick="javascript:hideTip();"/>
					</div>
					...
					<div class="Uploadiv">
						...
						<div class="tipinfo"
							...
							<div class="tipright">
								...
								<cite>您可以<a href="<%=path %>/edupm/teachermanage/toImportTeacherPage.htm?click=0'">继续导入</a>,或者<a
									href="<%=path %>/edupm/teachermanage/toImportRecordPage.htm?click=0">返回教师信息导入</a> </cite>
							</div>
						</div>
