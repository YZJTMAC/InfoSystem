		...
		<div class="place">
      	...
      	<div class="formbody">
    		<div id="usual1" class="usual"> 
    			<div class="itab">
				  	<ul> 
					    <li><a href="<%=basePathHeader %>/teacher/teachermanage/toRetireesAddPage.htm?click=4">发起离退休</a></li>
					    <li><a href="###" class="selected">已发起离退休</a></li> 
					    <li>
							<a href="<%=basePathHeader %>/edupm/teachermanage/toAdutiImportRecordPage.htm?click=4">教师离退休导入</a>
						</li>
						<!-- 
					    &nbsp;&nbsp;<input name="" type="button" class="scbtn" style="width: 155px;" value="导入离退休信息" onclick="window.location='<%=basePathHeader%>/teacher/teachermanage/toImportRetireesTeacherPage.htm?click=4'"/> 
						 -->
				  	</ul>
    			</div> 
    			<div id="tab1" class="tabson">
					<input type="hidden" id="changeTypeRetirees" value="1" />
       					...
       					<ul class="seachform" style="overflow:hidden">
						    ...
						    <li>
						       ...
						       -->
					       		<li>
						            <label>姓名：</label>
						            <input style="width: 70px" id="realName" name="input" type="text" class="scinput" value="" />
					          	</li>
					  			<li>
					            	<label>身份证：</label>
					            	<input  style="width: 160px" id="idNumber" name="input" type="text" class="scinput" value="" />
					         	</li>
						          <!-- 
						        </ul>
						        <ul class="seachform">
						    ...
						    <option value="2012">2012年</option>
					    		...
					    		<li><input  style="width: 80px" name="" type="button" onclick="showInfoList();" class="scbtn" value="搜索"/></li>
    					</ul>      
      				</div>
					...
					<div class="tip2" style="height: 300px; width: 530px;">
						<div class="tiptop2">
							<span>离退休详情</span><span>&nbsp;&nbsp;<b style="color: #F00;"></b></span><a></a>
						</div>
