				...
				<div id="usual1" class="usual">
					...
					<div class="itab">
						<ul id="action">
							...
							<li>
								<a id="N"
									href="<%=basePathHeader%>/teacher/teachermanage/toDeadAuditListPage.htm?click=1005&flag=N">待审核死亡登记</a>
							</li>
							<li>
								<a id="Y"
									href="<%=basePathHeader%>/teacher/teachermanage/toDeadAuditListPage.htm?click=1005&flag=Y">已审核死亡登记</a>
							</li>
						</ul>
					</div>
						...
						<div class="tabson">
							...
							<ul class="seachform">
								...
								<li>
									...
									<input id="changeType" type="hidden" value="32" />
