...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePathHeader%>/javascript/system/importSchool.js"></script>
			...
			<div class="formbody">
				...
				<div id="first" style="display: ''">
					...
					<form action="" id="fileForm" enctype="multipart/form-data"
						method="post">
						<input type="hidden" value="<%=request.getParameter("proId")%>"
							name="projectId">
					...
					<div class="Uploadiv">
						...
						<div class="tipinfo"
							...
							<div class="tipright">
								...
								<cite>您可以<a
									href="<%=basePathHeader%>/sys/toUploadPage.htm?click=2">继续导入</a>
								</cite>
							</div>
						</div>
