...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>添加实施机构管理员</title>
		<%@include file="../common/commonHead.jsp"%>
		<script type="text/javascript">
			var type = 2;
			var organizationId = <%= request.getParameter("organizationId")%>;
		</script>
		<script type="text/javascript" src="<%=basePathHeader%>/javascript/person/addOrgAdmin.js"></script>
		<script type="text/javascript">
				...
				<div class="loginContent">
					<table border="0" cellspacing="0" cellpadding="0" style="line-height:40px; margin:0 auto;">
						<tr>
							...
							<td>
								<select id="roleId" name="select" class="select2"></select>
					    ...
					    <tr>
					      	<td><b>*</b>真实姓名：</td>
					      	<td><input id="realName" type="text" class="scinput"/><i>2-20个汉字</i></td>
					    </tr>
					    <!-- <tr>
					    <td><b>*</b>身份证号：</td>
					  ...
					  <!-- <tr>
					    ...
					    <td><input id="teacherNo" type="text" class="scinput"/><i>教师编号</i></td>
					  	...
					  	<tr>
					    	<td></td>
					    	<td><input name="rt"  value="" id="imTeacher"/><!--<input name="rt" type="radio" value="" style="margin-left:20px;"/>我是管理员--></td>
						</tr>
					   	<tr>
