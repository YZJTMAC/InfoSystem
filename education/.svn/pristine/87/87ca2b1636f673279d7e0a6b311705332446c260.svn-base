...
<script type="text/javascript" src="<%=basePathHeader%>/javascript/furtheredu/creditEnterSchool.js"></script>
</head>
<body>
	<!-- top -->
	<div class="head">
...
<div class="chauxnJS jsTool">
				...
				<table class="tablelist">
						<thead>
							<tr>
								 <th width="4%">姓名</th><th width="4%">性别</th>
                <th width="5%">身份证号</th>
                <th width="30%">学校</th>
                <th width="6%">登记学分</th>
				   <th width="6%">审核状态</th>
...
{{/users}}
	...
	<!-- <div class="tip">
    	<div class="tiptop"><span>学分登记</span><a></a></div>
	 ...
	 <tr>
          <td colspan="3" >
			登记学分:<input type="text"  class="scinput"  id="txt_fp" value="0"/>学分
		  ...
		  <tr>
          <td  >
			<input id="sure" name="input2" type="button"
					class="dian3" value="确定" />
					</td><td>
			<input id="cancel" name="input2" type="button"
					class="dian3" value="取消" />
