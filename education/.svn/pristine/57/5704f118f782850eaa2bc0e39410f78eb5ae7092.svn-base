...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<%=basePathHeader%>/javascript/system/toViewRoleInfoPage.js">
		</script>
	</head>
	...
	<body>
		...
		<div class="content">
					...
					<div class="tabson" id="txtBox">
						...
						<table border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td colspan="4">
									<input name="roleName" id="roleName" type="text" value=""
										class="scinput" style="width: 471px;"  disabled ="disabled"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="4">
									<input name="stauts" id="stautsY" type="radio" disabled ="disabled"/>
									启用&nbsp;&nbsp;&nbsp;&nbsp;
									<input  name="stauts" id="stautsN" type="radio" disabled ="disabled"/>
									禁用
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="4">
									<textarea name="remark" id="remark"  disabled ="disabled"
			...
			<table style="width: 100%; height: 100%" disabled ="disabled">
				<tr>
					<td align="center">
