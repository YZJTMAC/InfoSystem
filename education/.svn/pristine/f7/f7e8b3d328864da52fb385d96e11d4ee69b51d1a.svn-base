...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<%=basePathHeader%>/javascript/furtheredu/updateYearCertificate.js"> </script>
		...
		<div class="content">
        	...
        	<div class="tipbtn">
				<table border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td>
							<a class="dian3" onclick="updateInfo()" id="save">修 改</a>
						</td>
						<td style="width: 30px;">
							&nbsp;
						</td>
