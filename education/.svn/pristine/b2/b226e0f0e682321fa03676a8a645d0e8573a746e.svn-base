...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<%=basePathHeader%>/javascript/system/addOrgAdminsList.js">
		</script>
		<script type="text/javascript" src="/javascript/system/kindeditor.js"></script>
		<script language="javascript" type="text/javascript" src="/javascript/system/WdatePicker.js"></script>
...
<div class="content">
  ...
  <p class="xmTool">承培机构名称：<b>${name}</b></p>
