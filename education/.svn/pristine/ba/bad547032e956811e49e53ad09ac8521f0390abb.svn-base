		...
		<div class="content">
			...
			<div class="formbody">
				...
				<ul class="seachform">
					<li>
						...
						<div class="vocation">
	          			...
	          			<a id="comparisonYearErr" style="color: red"></a>
					</li>
				</ul>
				<ul class="seachform">
					<li>
				...
				<ul class="seachform">
					<li>
						...
						<input type="text" name="auditStartDateValue" id="auditStartDateValue"
							...
							style="height: 32px; line-height: 32px; border-color: #a7b5bc #ced9df #ced9df #a7b5bc;"
							onClick="WdatePicker()">
							<a id="auditStartDateErr" style="color: red"></a>
					</li>
					<li>
						<label>
						...
						<input type="text" name="auditEndDateValue" id="auditEndDateValue"
							...
							style="height: 32px; line-height: 32px; border-color: #a7b5bc #ced9df #ced9df #a7b5bc;"
							onclick="WdatePicker()" />
						<a id="auditEndDateErr" style="color: red"></a>
					</li>
				</ul>
				<ul class="seachform">
					<li>
					...
					<li>
						...
						<input type="text" name="publishDateValue" id="publishDateValue"
							...
							style="height: 32px; line-height: 32px; border-color: #a7b5bc #ced9df #ced9df #a7b5bc;"
							onClick="WdatePicker()">
							<a id="publishDateErr" style="color: red"></a>
					</li>
				</ul>
				<ul class="seachform">
					<li>
					...
					<li>
						...
						<div class="vocation">
	          			...
	          			<a id="schoolsErr" style="color: red"></a>
					</li>
				</ul>
				...
				<form action="" id="proForm" enctype="multipart/form-data" method="post">
	      		...
	      		<ul class="seachform" style="padding-bottom: 10px; height: 100%; margin-top: 10px;margin-left: 10%">
					<li>
						<a href="javascript:saveInfo()" class="dian3" id="save">保 存</a>
					</li>
					<li>
						<a href="javascript:updateInfo()" class="dian3" id="update" style="display: none;">修 改</a>
					</li>
					<li>
						<a href="javascript:window.history.back();" class="dian3" >取 消</a>
					</li>
				</ul>
	      		</div>
			</div>
	    	...
	    	<div style="position:relative;margin-left: 20px;width: 90%;margin-top: 2%;float: left;">
	      	...
	      	<div style="position:relative;margin-top: 10px;margin-left: 20px;width: 90%;float: left;">
	      		...
	      		<table style="width:100%;margin-top: 10px;background-color:#E5E5E5;">
		        	<tbody id="city" style="text-align: left;">
		      		</tbody>
		        </table>
	      	</div>
	      	<div style="position: relative;margin-top: 10px;margin-left: 20px;width: 90%;float: left;">
	      		区级：
		      	<table style="width:100%;margin-top: 10px;background-color:#E5E5E5;">
		        	<tbody id="district" style="text-align: left;">
		      		</tbody>
		        </table>
	      	</div>
	      	<div style="position: relative;margin-top: 10px;margin-left: 20px;width: 90%;float: left;" >
