...
function downTeacherExcl() {
	...
	var queryIdNumber = $('#queryIdNumber').val();
	$("#downIframe", document.body).attr("src",pathHeader + "/edupm/projectmanage/downTeacherExcl.do?projectId="+ projectId +"&queryIdNumber="+queryIdNumber+"&areaId="+ areaId+"&areaType="+areaType);
}
...
//function showtongguo(projectId,id){
//	var url = pathHeader + "/edupm/projectmanage/toTeacherListForAuditchaxunbaoming.htm?click=26&projectId="+projectId+"&id="+id;
//	openWindow(url);
//}
//审核未通过
//function showbutongguo(projectId,id){
//	var url = pathHeader + "/edupm/projectmanage/toTeacherListForAuditchaxunbaoming.htm?click=26&projectId="+projectId+"&id="+id;
//	openWindow(url);
//}
...
function getTdHtml(obj){
	...
	var gender = obj.gender==null?"":obj.gender;
	var idc = obj.idNumber==null?"":obj.idNumber;
	var sub = obj.teachingSubject == null?"":obj.teachingSubject;
	var jobSchoolAdministrationOffice = obj.jobSchoolAdministrationOffice == null?"":obj.jobSchoolAdministrationOffice;
	...
	gridHtml += "<td>"+name+"</td>";
	gridHtml += "<td>"+gender+"</td>";
	gridHtml += "<td>"+idc+"</td>";
	gridHtml += "<td>"+sub+"</td>";
	gridHtml += "<td>"+jobSchoolAdministrationOffice+"</td>";
	gridHtml += "<td>"+pn+"</td>";
	gridHtml += "<td>"+cn+"</td>";
	gridHtml += "<td>"+dn+"</td>";
	gridHtml += "<td>"+sn+"</td>";
