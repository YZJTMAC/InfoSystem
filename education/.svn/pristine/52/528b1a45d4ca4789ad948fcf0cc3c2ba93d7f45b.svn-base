...
%>
<script type="text/javascript" src="<%=bacepath%>/javascript/common/commonSchoolSelect.js"></script>
   <div class="tip11" id="XXshow" style="display:none; z-index: 999999">
  ...
  <div class="XXshowContent">
    ...
    <div class="yincang">
    <p class="zhuyi" style="display: none"><cite style="float:left;">注意：请选择学校。</cite><cite style="float:right; margin-top:4px; margin-right:5px;"></cite></p>
