...
<script id="addEduPartB" type="text/x-jquery-tmpl">
		...
		<ul class="forminfo forminfo1" style="padding: 0; margin: 0;">
									<li>
										...
										<div class="vocation" style="padding-right: 8px;">
											<textarea disabled="disabled" name="mobilizeMark" id="mobilizeMark" cols=""
    ...
    <div class="itab">
  	<ul> 
    <li><a href="<%=basePathHeader %>/teacher/teachermanage/toDimissionAddPage.htm?click=13">发起离岗</a></li>
    <li><a href="###" class="selected">已发起离岗管理</a></li> 
     <li>
		<!-- <a href="###">教师离岗导入</a> -->
	</li>
  	</ul>
    ...
    <div id="tab1" class="tabson">
		<input type="hidden" id="changeType" value="34" /> 
    ...
    <li>
          ...
          <li>
            <label>姓名：</label>
            <input id="realName" name="input" style="width: 80px;" type="text" class="scinput" value="" />
          </li>
  <li>
            <label>身份证：</label>
    ...
    <li><input name="" type="button" onclick="showInfoList();" class="scbtn" value="搜索"/></li>
