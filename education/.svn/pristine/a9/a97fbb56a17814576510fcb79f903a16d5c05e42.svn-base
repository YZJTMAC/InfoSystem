...
<script type="text/javascript" src="<%=basePathHeader%>/javascript/furtheredu/scoreQuery.js"></script>
...
$(document).ready(function(e) {
	...
	var queryYear = '<%=request.getParameter("queryYear")%>';
    	...
    	<div class="formbody">
      		...
      		<div class="chauxnJS jsTool">
				<span style="float: left;">
					 <a href="javascript:void(0);"  style="margin-left: 6px" id="backBtn" onclick="javascript:window.history.back();">返回</a>
				</span>
			</div>		
