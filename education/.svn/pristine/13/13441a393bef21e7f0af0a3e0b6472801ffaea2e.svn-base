				...
				<div id="usual1" class="usual">
					...
					<div class="itab">
						<ul id="action">
							...
							<li>
								<a id="N"
									href="<%=basePathHeader%>/teacher/teachermanage/toDimissionAuditListPage.htm?click=1003&flag=N">待审核离岗</a>
							</li>
							<li>
								<a id="Y"
									href="<%=basePathHeader%>/teacher/teachermanage/toDimissionAuditListPage.htm?click=1003&flag=Y">已审核离岗</a>
							</li>
						</ul>
					</div>
						...
						<div class="tabson">
							...
							<ul class="seachform">
								...
								<li>
									...
									<input readonly="readonly" name="input" id="tss" value=""
								...
								<li>
									<input id="changeType" type="hidden" value="34" />
