...
<script type="text/javascript" src="<%=basePathHeader%>/javascript/system/importSSOrgs.js"></script>
</head>
<body>
	<!-- top -->
	<div class="head">
						...
						<div class="Uploadiv">
							<ul class="Uploadinfo">
								...
								<li style="text-align: center;">
									...
									<input type="button" class="btn" value="数据模板" style="float:left;margin-left:220px;" onclick="download('import_ssjg.xls');"/>
									&nbsp;&nbsp;&nbsp;&nbsp;
